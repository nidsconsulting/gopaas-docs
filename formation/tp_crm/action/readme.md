...
* Dans le menu **Application**, sélectionner le module **CRM**, puis sélectionner la table **Action**
...
* Cliquer sur l'onglet `Champs` pour afficher la liste des champs de la table **Action**.
...
Pour afficher les **Actions** liées dans la fiche **Compte**, il faut créer une vue liée. Pour celà on peut utiliser une vue existante et la dupliquer.
...
- Renommer la nouvelle vue avec la convention de nommage suivante:
  ...
  - `Actions` est le nom de la table enfant.
