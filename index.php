...
<div class="container">
    <div id="sidebar-left">
      <div id="sidebar-left-title">
        <img src="../asset/question.png" width="30px"/>&nbsp;&nbsp;GoPaaS HELP
      </div>
      <div class="chapter" onclick="window.location.href='index.php?rub=Introduction'">Introduction</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=Personnalisation'">Personnalisation</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=Vues'">Vues</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=Formulaire'">Formulaire</div>

      <div class="chapter" onclick="window.location.href='index.php?rub=References'">Références</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=Import'">Import</div>

      <div class="chapter" onclick="window.location.href='index.php?rub=Dashboard'">Dashboard</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=WebReport'">WebReport</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=Modele_lettre'">Modèle de lettre</div>

      <div class="chapter" onclick="window.location.href='index.php?rub=Automatisation'">Automatisation</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=Workflow'">Workflow</div>

      <div class="chapter" onclick="window.location.href='index.php?rub=Admin'">Admin</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=API'">API</div>
      <div class="chapter" onclick="window.location.href='index.php?rub=JS'">JS</div>
    </div>
    <div id="content">
